...
APPROVED_HOSTS = set(["google1.com", "ww1.google.com", "yahoo.com", "wcofun.com", "torrentgalaxy.to"])
CHUNK_SIZE = 1024
...
def make_request(url, method, headers={}, data=None):
    ...
    return requests.request(method, url, params=request.args, stream=True, headers=headers, allow_redirects=True, data=data)
